              ...
              <div className="p-6">
                ...
                <ul className="py-6 border-y border-slate-100 dark:border-gray-800 flex items-center list-none">
                  ...
                  <li className="flex items-center me-4">
                    ...
                    <Unicons.UilMinusPath className="me-2 text-green-600" />
                    <span>{item.beds} مرايا</span>
                  </li>

                  <li className="flex items-center">
                    <Unicons.UilBath className="me-2 text-green-600" />
                    <span>{item.baths} الاحواض</span>
                  </li>
                </ul>
                ...
                <ul className="pt-6 flex justify-between items-center list-none">
                  <li>
                    ...
                    <p className="text-lg font-medium">SR {item.price}</p>
                  </li>

                  <li>
                    <span className="text-slate-400">التقيم</span>
