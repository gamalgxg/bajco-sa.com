                    ...
                    <div className="md:flex justify-center">
                        ...
                        <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                                ...
                                <ul className="list-unstyled text-slate-400 mt-4">
                                    <li className="flex mt-2"><Unicons.UilArrowRight width={18} className="text-green-600 align-middle me-2"/>Digital Marketing Solutions for Tomorrow</li>
                                    <li className="flex mt-2"><Unicons.UilArrowRight width={18} className="text-green-600 align-middle me-2"/>Our Talented & Experienced Marketing Agency</li>
                                    <li className="flex mt-2"><Unicons.UilArrowRight width={18} className="text-green-600 align-middle me-2"/>Create your own skin to match your brand</li>
                                    <li className="flex mt-2"><Unicons.UilArrowRight width={18} className="text-green-600 align-middle me-2"/>Digital Marketing Solutions for Tomorrow</li>
                                    <li className="flex mt-2"><Unicons.UilArrowRight width={18} className="text-green-600 align-middle me-2"/>Our Talented & Experienced Marketing Agency</li>
                                    <li className="flex mt-2"><Unicons.UilArrowRight width={18} className="text-green-600 align-middle me-2"/>Create your own skin to match your brand</li>
                                </ul>
                                ...
                                <div className="mt-8">
                                    <Link href="#" className="btn bg-green-600 hover:bg-green-700 text-white rounded-md">Print</Link>
                                </div>
                            </div>
                        </div>
                    </div>
