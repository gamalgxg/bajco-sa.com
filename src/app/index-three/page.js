                ...
                <div className="container">
                    ...
                    <div className="md:flex justify-center text-center mt-6">
                        <div className="md:w-full">
                            <Link href="/list" className="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">View More Properties <i className="uil uil-arrow-right ms-1"></i><Unicons.UilArrowRight width={18} className="ms-1"/></Link>
                        </div>
                    </div>
                </div>
